...
| №  | Дата       | Время | Тема                                          |
|----|------------|-------|-----------------------------------------------|
| 1  | 1.04.2025  | 20:30 | Введение. Задача генерации                    |
| 2  | 5.04.2025  | 13:30 | Автоенкодеры                                  |
| 3  | 8.04.2025  | 20:30 | GAN                                           |
| 4  | 12.04.2025 | 13:30 | GAN: семинар                                  |
| 5  | 15.04.2025 | 20:30 | Семплирование GAN                             |
| 6  | 19.04.2025 | 13:30 | Трансформеры. Attention                       |
| 7  | 22.04.2025 | 20:30 | Введение в LLM                                |
| 8  | 26.04.2025 | 13:30 | Q&A                                           |
| 9  | 29.04.2025 | 20:30 | Введение в диффузионные модели                |
| 10 | 3.05.2025  | 13:30 | Имплементация диффузионных моделей            |
| 11 | 6.05.2025  | 20:30 | Модификации диффузионных моделей              |
| 12 | 10.05.2025 | 13:30 | Тюнинг диффузионных моделей                   |
| 13 | 13.05.2025 | 20:30 | Семинар: иструменты использования ген моделей |
| 14 | 17.05.2025 | 13:30 | Q&A                                           |
| 15 | 20.05.2025 | 20:30 | Доклады                                       |
| 16 | 24.05.2025 | 13:30 | Доклады\Зачет                                 |

## Оценивание

| ДЗ                                   | Где лежит                      | Кол-во баллов | deadline |
|--------------------------------------|--------------------------------|---------------|----------|
| Байесовская генерация и автоэнкодеры | HW_1.Bias_gen_and_autoencoders | 25            | 29.04.25 |
| Имплементация и обучение GAN         | HW_2.GAN_train                 | 30            | 13.05.25 |
| Семплирование в StyleGAN             | HW_3.StyleGAN_sampling         | 15            | 17.05.25 |
| Обучение Stable Diffusion            | HW_4.SD1.5_train               | 30            | 20.05.25 |
| Доклады                              |                                | 10            | 24.05.25 |
| Устный экзамен                       |                                | до 10         | 24.05.25 |
...
Для того чтобы отправить ДЗ на провекрку поставте в [таблице](https://docs.google.com/spreadsheets/d/1BZ4fyhir6eVLp9aGCx-Y2s1PzVjsTcJE7mpJmE6KoX4/edit?usp=sharing) на против своей фамилии в соответствующей колонке '+'. После проверки вместо него появятся баллы.
...
Поставьте в [таблице](https://docs.google.com/spreadsheets/d/1DBVwCTdZ1kL9ZuwCPllHSJv-6mMwItmQYewBG_ODL9M/edit?gid=1860629658#gid=1860629658) напротив своей фамилии в соответствующей колонке комментарий '+' и напишите вашему ментору в тг. Когда ментор проверит ДЗ, он оставит свою обратную связь вам в личку в тг или комментарием в ячейке.
