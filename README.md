...
Репозиторий с материалами курса "Глубокие генеративные модели (Deep Generative Models)" в AITalentHub.
...
|--------------------------------------|--------------------------------|---------------|----------|
| Байесовская генерация и автоэнкодеры | HW_1.Bias_gen_and_autoencoders | 15            | 01.06.25 |
